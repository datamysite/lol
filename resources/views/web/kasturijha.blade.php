    ...
    <div class="social-media-wi">
        <ul>
            ...
            <li class="wi-instagram">
                <a class="nav-link" href="https://www.instagram.com/askforkasturi" target="_blank" class="text-theme"><i class="fab fa-instagram"></i></a>
            </li>
